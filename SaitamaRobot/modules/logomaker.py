...
async def lego(event):
 ...
 try:
    ...
    fname2 = "LogoByAiger.png"
    img.save(fname2, "png")
    await tbot.send_file(event.chat_id, fname2, caption="Made By @AigerAkabaneRobot ")
    if os.path.exists(fname2):
            os.remove(fname2)
 except Exception as e:
   await event.reply(f'Error Occured. Report at @AigerAkabaneSupport, {e}')
